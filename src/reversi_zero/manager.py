...
CMD_LIST = ["self", "opt", "eval", "play_cli", "play_gui", "nboard"]
...
def start():
    ...
    if args.type:
        print(
            "I'm very sorry. --type option was deprecated. Please use -c option instead!"
        )
        return 1
    ...
    elif args.cmd == "play_cli":
        from .play_game import cli

        return cli.start(config)
